...
# FTP server details
ftp_server = '127.0.0.1'  # or use the IP address of the Raspberry Pi
ftp_username = 'admin'  # replace with your Raspberry Pi username
ftp_password = '1'  # replace with your Raspberry Pi password
local_path = 'c:/Users/Administrator/Pictures/Saved Pictures/'  # Replace with the local directory to monitor
